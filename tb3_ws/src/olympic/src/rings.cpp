...
int main(int argc, char **argv)
{
  ...
  request_setpen->r = colors[2][0]; 
  request_setpen->g = colors[2][1];
  request_setpen->b = colors[2][2];
  ...
  request_teleport_absolute->x = positions[2][0];
  request_teleport_absolute->y = positions[2][1];
